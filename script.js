...
const words = {
  ...
  text2: ["é", "significa", "precisa", "assume", "reinvidica", "exige", "defende", "clama", "contesta",
          ...
          "precisa", "provoca", "reafirma", "reflete", "registra", "relata", "repete", "responde", "requer", "respira",
          "ressalta", "revela", "sustenta", "tece", "testemunha", "toma", "traduz", "transforma", "transpira", "une", "usa", "valida",
  ...
  text3: ["vontade de", "desejo de", "necessidade de", "ânsia de",
          ...
          "cobiça por", "gana de", "perspectiva de"],
